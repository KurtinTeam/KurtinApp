//package com.kurtin.kurtin.networking;
//
...
public class InstagramApi extends DefaultApi20 {
    ...
    public String getAuthorizationUrl(OAuthConfig config) {
        return String.format(URL, config.getApiKey(), OAuthEncoder.encode(config.getCallback()), InstagramApi.getScope());
    ...
    public OAuthService createService(final OAuthConfig config) {
        return new OAuth20ServiceImpl(this, config) {
            ...
            public Token getAccessToken(Token requestToken, Verifier verifier) {
                ...
                if (config.hasScope()) request.addBodyParameter(OAuthConstants.SCOPE, InstagramApi.getScope());
